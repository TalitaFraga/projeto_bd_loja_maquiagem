-- Excluir BD
-- DROP DATABASE maquiagem_db_v2;

-- Criação do banco

CREATE DATABASE maquiagem_db_v2;
...
CREATE TABLE gerencia (
    funcionario_a_fk_pessoa_cpf VARCHAR(14) UNIQUE NOT NULL,
    funcionario_b_fk_pessoa_cpf VARCHAR(14) UNIQUE NOT NULL,
...
CREATE TABLE venda (
    ...
    CONSTRAINT chk_qtde_venda CHECK (qtde_produto > 0)
);
...
('11.222.333/0001-44', 'Beleza Distribuidora', '(81)98888-0000', NULL);
...
-- Trigger para validar data de validade (alternativa ao CHECK (data_nasc < CURRENT_DATE))
...
(UUID(), '390.533.447-05', '1001', 'L001', '865.443.027-53', NOW(), 2),
(UUID(), '104.407.477-60', '2002', 'L002', '865.443.027-53', NOW(), 1),
(UUID(), '614.284.623-02', '3001', 'L001', '865.443.027-53', NOW(), 3);
